...
import votes_pb2 as votes__pb2
...
class PollsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPolls = channel.unary_unary(
                ...
                response_deserializer=votes__pb2.GetPollsReply.FromString,
                )
        self.CreatePoll = channel.unary_unary(
                '/Polls/CreatePoll',
                request_serializer=votes__pb2.PollRequest.SerializeToString,
                response_deserializer=votes__pb2.Poll.FromString,
                )
...
def add_PollsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetPolls': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=votes__pb2.GetPollsReply.SerializeToString,
            ),
            'CreatePoll': grpc.unary_unary_rpc_method_handler(
                    servicer.CreatePoll,
                    request_deserializer=votes__pb2.PollRequest.FromString,
                    response_serializer=votes__pb2.Poll.SerializeToString,
            ),
...
class Polls(object):
    ...
    def GetPolls(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Polls/GetPolls',
            ...
            votes__pb2.GetPollsReply.FromString,
    ...
    def CreatePoll(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Polls/CreatePoll',
            votes__pb2.PollRequest.SerializeToString,
            votes__pb2.Poll.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
